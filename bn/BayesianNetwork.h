...
/**  @name Lookup */
    ...
    Node* 	getNodeByName(const std::string &nodeName)  { return &index_to_nodes_[ name_to_index_[nodeName] ]; }
    /// Find a node by index in this BayesianNetwork.
    Node* 	getNodeByIndex(size_t nodeIndex) { return &index_to_nodes_[nodeIndex]; }
